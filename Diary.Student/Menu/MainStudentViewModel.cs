...
namespace Diary.Student.Menu
{
    [Plugin("Main", DPlugin.MainStudent, DPlugin.Student)]
    internal class MainStudentViewModel : Conductor<IDPlugin>.Collection.OneActive, IDPlugin
    {
        ...
        {
            var id = PluginHelper.ValueOfIdAttribute<MainStudentViewModel>();
