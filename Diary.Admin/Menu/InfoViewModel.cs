...
{
    [Plugin("Info", DPlugin.Info, DPlugin.Admin)]
    public class InfoViewModel : Conductor<IDPlugin>.Collection.OneActive, IDPlugin
    {
        ...
        {
            var id = PluginHelper.ValueOfIdAttribute<InfoViewModel>();
