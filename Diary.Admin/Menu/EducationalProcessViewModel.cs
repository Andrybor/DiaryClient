...
{
    [Plugin("EducationalProcess", DPlugin.EducationalProcess, DPlugin.Admin)]
    public class EducationalProcessViewModel : Conductor<IDPlugin>.Collection.OneActive, IDPlugin
    {
        ...
        {
            var id = PluginHelper.ValueOfIdAttribute<EducationalProcessViewModel>();
