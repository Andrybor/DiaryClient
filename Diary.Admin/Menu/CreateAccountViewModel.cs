...
{
    [Plugin("Accounts", DPlugin.Create, DPlugin.Admin)]
    public class CreateAccountViewModel : Conductor<IDPlugin>.Collection.OneActive, IDPlugin
    {
        ...
        {
            var id = PluginHelper.ValueOfIdAttribute<CreateAccountViewModel>();
